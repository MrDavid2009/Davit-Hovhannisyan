...
export function AuthScreen({ onAuthSuccess, allUsers, onRegisterUser }: AuthScreenProps) {
  ...
  return (
    <div id="auth-screen-root" className="auth-cosmic-bg min-h-screen flex flex-col justify-center items-center py-14 px-4 sm:px-6 lg:px-8 transition-colors duration-300 relative overflow-hidden select-none">

      {/* Затемнение поверх космического фона, чтобы текст и шрифты идеально читались */}
